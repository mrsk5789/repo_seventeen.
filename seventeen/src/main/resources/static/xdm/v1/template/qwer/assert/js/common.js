...
let form=document.querySelector("form[name=form]");
  ...
  form.action="/xdm/v1/infra/codegroup/codegroupXdmUele";
  form.submit();
}
...
let form=document.querySelector("form[name=form]");
  ...
  form.action="/xdm/v1/infra/codegroup/codegroupXdmDele";
  form.submit();
}
...
form.action="/xdm/v1/infra/code/codeXdmUele";
form.submit();
}
...
form.action="/xdm/v1/infra/code/codeXdmDele";
form.submit();
}
...
form.action="/xdm/v1/infra/member/memberXdmUele";
form.submit();
}
...
form.action="/xdm/v1/infra/member/memberXdmDele";
form.submit();
}
